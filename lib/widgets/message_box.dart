...
class MessageBox extends StatelessWidget {
  ...
  MessageBox({Key? key, required this.message, required this.time, required this.isSelf}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      ...
      child: Column(
        ...
        children: [
          Text(timeFormat.format(dateTime), style: _messageTopLabelStyle),
          Container(
